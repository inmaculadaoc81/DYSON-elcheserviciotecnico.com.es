...
fallbackToggle.className = 'dysonrestore-chat-fallback';
fallbackToggle.setAttribute('aria-label', 'Abrir chatbot DysonRestore');
...
if (target && !target.dataset.dysonrestoreChatInitialized) {
  target.dataset.dysonrestoreChatInitialized = 'true';
